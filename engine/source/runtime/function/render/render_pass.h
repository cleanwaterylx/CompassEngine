...
namespace Compass
{
    ...
    enum 
    {
        ...
        _main_camera_pass_post_process_buffer_odd       = 6,
        _main_camera_pass_post_process_buffer_even      = 7,
        _main_camera_pass_depth                         = 8,
        _main_camera_pass_swap_chain_image              = 9,
        _main_camera_pass_custom_attachment_count       = 6,
        _main_camera_pass_post_process_attachment_count = 2,
        _main_camera_pass_attachment_count              = 10,
    };
