...
namespace Compass
{
    ...
    public:
        ...
        static VkSampler getOrCreateRepeatSampler(VkPhysicalDevice physical_device, VkDevice device);
        static void      destroyNearestSampler(VkDevice device);
        static void      destroyLinearSampler(VkDevice device);
        static void      destroyRepeatSampler(VkDevice device);
    ...
    private:
        ...
        static VkSampler                               m_repeat_sampler;
